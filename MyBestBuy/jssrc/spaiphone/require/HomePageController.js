define("userHomePageController", {
    ...
    HomePage_Header_Search_OnClick: function() {
        this.view.FlexSearchBar.animate(kony.ui.createAnimation({
            "100": {
                "top": "10%",
                "stepConfig": {
        ...
        this.view.FlexMainContent.animate(kony.ui.createAnimation({
            "100": {
                "top": "20%",
                "stepConfig": {
                    "timingFunction": kony.anim.EASE
...
define("HomePageControllerActions", {
    /*
...
define("HomePageController", ["userHomePageController", "HomePageControllerActions"], function() {
    var controller = require("userHomePageController");
    var controllerActions = ["HomePageControllerActions"];
